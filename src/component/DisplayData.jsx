...
const showData = event => {
  // getID(data.id, data.firstName, data.middleName, data.lastName, data.age, data.address, data.number)
  // setFirstName("Hervey Geralph");
  // setMiddleName("Cabig");
  // setLastName("Mapano");
  // setAge("20");
  // setAddress("Carmen");
  // setNumber("09094971730");
  console.log(data.firstName);
};
    const handlePrint = event => {
      
      console.log('Print anchor clicked in');
     if(firstName !== ""){
